    ...
    <Box>
      <Box fontSize={"12px"} p="15px">
        <Text mt="10px" cursor={"pointer"}>
          ...
          Bounce Infinity E1 | Buy Laptop on EMI | vivo T1X | OPPO Reno8 5G |
          OPPO Reno8 Pro 5G | Nothing Phone 1 | Sell Old Mobile Phones | ASUS
          TUF Gaming F15 Core i5 10th Gen | Electronics Store | OPPO A16K | Vivo
          Y33T | OPPO Reno7 5G | Okaya Electric Vehicles | bgauss electric
          scooter | OPPO Reno7 Pro 5G | iPhone 13 | iPhone 13 Pro | iPhone 13
          Pro Max | iPhone 13 Mini | Google Pixel 6a covers | Flipkart Quick |
          Ampere Magnus | Flipkart Help Centre | Online Boat Store | Covers from
          Rs 99 | Flipkart Track Orders | Flipkart Manage Orders | Flipkart
          Return Orders | Flipkart Gift Cards Store | Flipkart Axis Bank Credit
          Card | Flipkart Pay Later
        </Text>
        <Text mt="10px" cursor={"pointer"}>
          <span style={{ fontSize: "14px" }}>MOBILES: </span> iPhone 12 64GB |
          iPhone 12 Pro 512GB | iPhone 12 128GB | Vivo Y91i | Vivo Y11 | Vivo
          Y15 | Vivo Y50 | Vivo Y12 | Reno2 F | Oppo A12 | Oppo F15 | Oppo A31 |
          Samsung A71 | Samsung A51 | Samsung A31 | Realme X2 | iPhone 11 |
          iPhone 11 Pro | iPhone 11 Pro Max | Mobile Offers | iphone x4G Mobile
          | Nokia Mobile | Samsung Mobile | iphone | Oppo Mobile | Vivo Mobile
        </Text>
        <Text mt="10px" cursor={"pointer"}>
          <span style={{ fontSize: "14px" }}>CAMERA: </span> GoPro Action Camera
          | Nikon Camera | Canon Camera | Sony Camera | Canon DSLR | Nikon DSLR
        </Text>
        <Text cursor={"pointer"} mt="10px">
          <span style={{ fontSize: "14px" }}>LAPTOPS: </span> MacBook Pro M2 |
          Premium Laptop | acer Ryzen 3 Dual Core 3250U - (8 GB/256 GB
          ...
          Apple Laptops | Acer Laptops | Lenovo Laptops | Dell Laptops | Asus
          Laptops | HP Laptops | Gaming Laptops | 2 in 1 Laptops | Laptops |
          Dell latest laptops 2022 | HP latest laptops 2022 | Infinix INBook X1
          Neo Series Celeron Quad Core - (8 GB/256 GB SSD/Windows 11 Home) XL22
          Thin and Light Laptop | Microsoft Laptops | 12th Gen Intel Core
          Laptops
        </Text>
        <Text cursor={"pointer"} mt="10px">
          <span style={{ fontSize: "14px" }}>TVs: </span> Nokia TV | Panasonic
          TV | Thomson TV | Vu TV | Realme TV | Motorola TV | OnePlus TVs | LG
          TV | TV | Sony TV | Samsung TV | Android Television | Iffalcon Tv | Mi
          TV
        </Text>
        <Text cursor={"pointer"} mt="10px">
          <span style={{ fontSize: "14px" }}>LARGE APPLIANCES: </span> TV &
          Appliances End of Season Sale | Television | Washing Machines |
        ...
        <Text cursor={"pointer"} mt="10px">
          <span style={{ fontSize: "14px" }}>CLOTHING: </span> Men Shirts| Kurta
          Pajama | Kurtas | Men T-Shirts | Jeans | Saree | Dresses | Kids
          Dresses | Designer Salwar Suits | Bra | Designer Kurtis | Track Pant |
          Men Kurtas | Gym Wear | Party Dresses | Palazzo Suits | Boys Clothing
          | Gloves | Nighty | Maxi Dresses | Anarkali | Gowns | Culottes |
          Salwar Suits | Kurtis | Designer Sarees | Leggings | Shorts |
          Georgette Sarees | Ethnic Wear | Briefs & Trunks | Nike Watches |
          Ascot Tie | Corset Tops Tunics | Leather PU Skirts | Corset tops
          camisoles | Women magenta earrings | No collar jackets | Green dress
          material | Black patiala kurta set | Men camel shoes casual | Black
          pathani | Tassel Sarees | Khaki dresses | Kids formal dresses | Mauve
          shirts | Women henleyuppada pattu sarees | Leopard dresses |
          Sleeveless shrugs
        </Text>
        <Text cursor={"pointer"} mt="10px">
          <span style={{ fontSize: "14px" }}>FOOTWEAR: </span>Shoes | Adidas
          Shoes | Reebok Shoes | Nike Shoes | Puma Shoes | Boots | Bata Shoes |
          Woodland Shoes | Skechers Shoes | Sneakers | Womens Boots | Sports
          Shoes | Loafers | Sandals | Lotto Sports Shoes | Casual Shoes | Womens
          Skechers Shoes | Asics Sports Shoes | Formal Shoes | School Shoes
        </Text>
        <Text cursor={"pointer"} mt="10px">
          <span style={{ fontSize: "14px" }}>GROCERIES: </span>PhonePe Grocery
          Voucher | Hand Wash | Soap | Cashew Nuts | Sunflower Oil | Eggs |
          Toilet Cleaner | Harpic Toilet Cleaner | Dettol Soap | Mustard Oil |
          Biscuits | Cheese | Patanjali Atta | Fortune Oil | Aashirvaad Atta |
          Tea
        </Text>
        <Text cursor={"pointer"} mt="10px">
          <span style={{ fontSize: "14px" }}>BEST SELLING ON FLIPKART: </span>{" "}
          Fire-Boltt Ninja Calling Pro Bluetooth Calling Smartwatch 1.69 inch HD
          Display Smartwatch | Best Gas Geyser | Kitchen Geyser | Nutri Blenders
          | Portable Air Cooler | Best Air Cooler | Bags | Hitachi Refrigerator
          3 Door | Books | Toys | Candles | Helmets | Wall Clocks | Baby Food |
          Chocolates | Cycles | Calculators | Lipsticks | Mask | Vertiv UPS |
          Fastrack Watches | Wallets | Earrings | Gold Coins | Realme Pad Mini |
          Handbagsconekt SW2 Smartwatch | Mivi DuoPods a350 | Speaker Cleaner
        </Text>
        <Text cursor={"pointer"} mt="10px">
          <span style={{ fontSize: "14px" }}>FURNITURE: </span> Furniture |
          Sofas | Beds | Dining sets | Wardrobes | Mattresses | TV Units |
          Tables | Chairs | Shelves | Bean Bags | Office Chairs | Computer Table
          | Office Tables | Red Sofa | Wakefit Beds | White Sofa | Wakefit
          Mattress | Green Sofa | Black Sofa | Brown Sofa
        </Text>
        <Text cursor={"pointer"} mt="10px">
          <span style={{ fontSize: "14px" }}>BGMH: </span> Whey Protein |
          Homeopathy | Bounce Infinity | Christmas Gifts | Calendar 2023 |
          Online Guitar | Books Store | Musical Instrument Store | Dabur
          Chyawanprash | Baidyanath Chyawanprash | Energy Drinks | Toys | Milk
          Drink Mixes | Rakhi | Chyawanprash | Indian Flag | Protein Supplements
        </Text>
      </Box>
      <Box textAlign={"left"} color="grey" p="15px">
        <Box mt="15px">
          <Text fontWeight={"700"}>
            Flipkart: The One-stop Shopping Destination
          </Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Flipkart Plus</Text>
          <Text mt="8px" fontSize={"x-small"}>
          ...
          <Text mt="8px" fontSize={"x-small"}>
            ...
            <br /> Rupees 550 instant discount on flights on ixigo
            <br /> Check out https://www.flipkart.com/plus/all-offers for the
            entire list. Terms and conditions apply.
          </Text>
        </Box>
        <Box mt="15px">
          <Text fontWeight={"700"}>No Cost EMI</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>EMI on Debit Cards</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Mobile Exchange Offers</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>What Can You Buy From Flipkart?</Text>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Electronic Devices and Accessories</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Large Appliances</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Small Home Appliances</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Lifestyle</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Home and Furniture</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Baby and Kids</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Books, Sports and Games</Text>
          <Text mt="8px" fontSize={"x-small"}>
        ...
        <Box mt="15px">
          <Text fontWeight={"700"}>Grocery/Supermart</Text>
          <Text mt="8px" fontSize={"x-small"}>
