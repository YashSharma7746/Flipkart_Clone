...
import { GetToys } from "../../../redux/InductionProducts/Induction.actions";
...
const Induction = () => {
  ...
  const store = useSelector((store) => store.inductionProductManager);
  useEffect(() => {
    dispatch(GetToys());
  }, []);
  console.log(store, "a");
  ...
  return (
    <>
      <Heading mb="20px" fontSize={"20px"} pt="5px" pb="10px">
        Showing Results for Inductions
      </Heading>
      <Box display={"flex"}>
